...
public class PrizeWinnerStore extends ReadingListItemStore {
    ...
    public PrizeWinnerStore(String file) throws IOException{
    ...
    public PrizeWinnerStore(String file, int maxPrefixLength) throws IOException {
